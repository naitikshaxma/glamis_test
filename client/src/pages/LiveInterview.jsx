...
const LiveInterview = () => {
  ...
  const [videoWarning, setVideoWarning] = useState(true);
        ...
        <div
          ...
          <div className='bg-white p-8 rounded-lg'>
            <p className='text-lg font-semibold'>
              ⚠ Warning: Video Monitoring in Progress
            </p>
            <p className='text-lg font-semibold'>
              Your video is being continuously monitored throughout the interview phase.
            </p>
            <p className='text-lg font-semibold'>
              Any form of suspicious activity, including but not limited to:
            </p>
            <ul className='list-disc pl-8 text-lg'>
              <li>Looking away frequently or reading from another screen</li>
              <li>Receiving external assistance or using unauthorized devices</li>
              <li>Switching tabs or attempting to browse for answers</li>
              <li>Background voices or multiple people in the frame</li>
            </ul>
            <p className='text-lg font-semibold'>
              Such activities will directly impact your final score without prior notification.
            </p>
            <p className='text-lg font-semibold'>
              Ensure a fair and honest interview process.
            </p>
            <div className='flex justify-end'>
              <button
                className='bg-blue-500 text-white p-2 rounded-lg mt-4'
                onClick={() => setVideoWarning(false)}
              >
                OK, I Understand
              </button>
            </div>
          ...
          <div className="flex w-full">
            ...
            <div className="flex flex-col items-center w-3/4">
              <div className="timer-tab w-full flex justify-between p-4 items-center">
                ...
                <div className="timer">
                  {timer && !loading &&
                    <Timer timer={timer} setTimer={setTimer} handleNextQuestion={handleNextQuestion}/>}
                </div>
              </div>
