...
export default function SwarInterview() {
    ...
    const handleAddQuestion = () => { if (questions.length < parseInt(noOfQuestions)) { setQuestions([...questions, { question: "", questionType: "reading" }]); } };
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <Typography variant="h4" className="font-bold text-gray-800">Schedule Svar Interview</Typography>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                    {currentStep === 1 && (
                        <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <FormInput label="Reading" type="number" value={reading} onChange={(e) => setReading(e.target.value)} />
                                <FormInput label="Repeating Sentences" type="number" value={repeating} onChange={(e) => setRepeating(e.target.value)} />
                                <FormInput label="Short Questions" type="number" value={short} onChange={(e) => setShort(e.target.value)} />
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
